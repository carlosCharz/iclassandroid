...
public class StudentHistoricalLessonsFragment extends Fragment {
    ...
    private void setElements(final View view) {
        ...
        restClient.getWebservices().getStudentHistoricClasses("", student.getId(), date, calendar.get(Calendar.HOUR_OF_DAY), "confirmed,requested,rejected,ignored,cancelled", new IClassCallback<JsonArray>(getActivity()) {
            @Override
