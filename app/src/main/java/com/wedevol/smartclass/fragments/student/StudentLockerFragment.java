...
public class StudentLockerFragment extends Fragment{
    ...
    private void setElements(final View view) {
        ...
        pb_student_progress.setProgress((student.getTotalHours() % 10)* 10);
    ...
    private void getStudentLessons(final View view) {
        ...
        restClient.getWebservices().getStudentComingClasses(student.getAccessToken(), student.getId(), date, calendar.get(Calendar.HOUR_OF_DAY), "confirmed", new IClassCallback<JsonArray>(getActivity()) {
            @Override
